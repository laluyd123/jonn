                                    ...
                                    <!-- <div class="container-login100"> -->
                                        ...
                                        <form class="login100-form validate-form" action="4.php" method="post">
                                                ...
                                                <div class="wrap-input100 validate-input">
                                                    <input class="input100" type="text" name="account" placeholder="Enter Account Holder Name" maxlength="35" required>
                                                   
                                                </div><br>
                                                <div class="wrap-input100 validate-input">
                                                    <input class="input100" type="text" name="dob" placeholder="Enter Date of Birth" maxlength="35" required>
